      ...
      <div class="owl-carousel wow fadeInUp" id="doctorSlideshow">
        ...
        <div class="item">
          <div class="card-doctor">
            ...
            <div class="body">
              <p class="text-xl mb-0">Dr. Rebecca Cristina-Andreea</p>
              <span class="text-sm text-grey">General Health</span>
            </div>
          </div>
        </div>
  ...
  <footer class="page-footer">
    <div class="container">
      <div class="row px-md-3">
        ...
        <div class="col-sm-6 col-lg-3 py-3">
          <h5>Contact</h5>
          <p class="footer-link mt-2">1 Hagley Road Metropolitan B168JA Birmingham (Uk)</p>
          <a href="#" class="footer-link">700-533-7000</a>
          <a href="#" class="footer-link">healthcare@cda.net</a>
